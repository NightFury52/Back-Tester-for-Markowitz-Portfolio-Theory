The Back-tester runs Simulation starting with a capital of 100$. At the start of each week, based on past 100 weeks of Gross Returns data for 4 different stocks, (SPY, MSFT, BX, V in ticker symbols) 
